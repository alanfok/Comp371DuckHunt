...
void SkyBox::Draw(const glm::mat4& view, const glm::mat4& projection)
{
	...
	glUniformMatrix4fv(WorldMatrixLocation, 1, GL_FALSE, &mview[0][0]);

	WorldMatrixLocation = glGetUniformLocation(Renderer::GetShaderProgramID(), "ProjectonTransform");
	glUniformMatrix4fv(WorldMatrixLocation, 1, GL_FALSE, &projection[0][0]);
